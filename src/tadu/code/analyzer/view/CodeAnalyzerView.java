...
public class CodeAnalyzerView {
	...
	public static void main(String[] args) {
		try {
			CodeAnalyzerView window = new CodeAnalyzerView();
			window.open();
		} catch (Exception e) {
	...
	protected void createContents() {
		...
		GridData gd_coreSvnUrlText = new GridData(SWT.FILL, SWT.CENTER, false, false, 8, 1);
		...
		webSvnUrlText.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 8, 1));
...
//				java.util.List<IPath> ipaths = JDTUtils.doFileSearch(TaduJavaProject.WEB_PROJECT, "v2.60/space.css", "*.shtml");
		...
		GridData gdLabel = new GridData(SWT.FILL, SWT.CENTER, true, false, 9, 3);
		...
		list.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 9, 1));
		...
		GridData gdGroup = new GridData(SWT.FILL, SWT.CENTER, true, true, 9, 1);
